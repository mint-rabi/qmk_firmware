...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |  ESC |  DEL |   N  |   M  |   ,  |   .  |   /  |¥_ / S|
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Grv   | Esc  | MuHen| GUI  | Alt  |Lower |Space |Enter |Raise | LNG2 | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      KC_LSFT,  KC_Z,    KC_X,     KC_C,    KC_V,   KC_B,  KC_ESC , KC_DEL,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_T(JA_ENUN) , \
      KC_GRV,   KC_ESC,  KC_MHEN,  KC_LGUI, KC_LALT,LOWER, KC_SPC , KC_ENT,  RAISE,   KC_RALT ,KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = KEYMAP( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_UNDS, KC_PLUS, JA_LBRC, JA_RBRC, S(JA_ENVL), \
  ...
  [_RAISE] = KEYMAP( \
      ...
      _______, _______, _______, _______, _______, _______, KC_BSPC, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
