...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Grv   | Esc  | Alt  | GUI  | Alt  |Lower |Space |Enter |Raise | LNG2 | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      KC_GRV,   KC_ESC,  KC_LALT,  KC_LGUI, KC_LALT,LOWER, KC_SPC , KC_ENT,  RAISE,   KC_RALT ,KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
