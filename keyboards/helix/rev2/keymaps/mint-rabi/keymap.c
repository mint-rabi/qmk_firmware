...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Up   | Down | GUI  | Alt  | Lower|SPC   |BKSP  |ESC   |Enter | Rise | Alt  | Grv  | Left |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      XXXXXXX,  XXXXXXX, KC_LGUI,  KC_LALT, LOWER  ,KC_SPC,KC_BSPC, KC_ESC,  KC_ENT,  RAISE   ,KC_RALT, KC_GRV , XXXXXXX, XXXXXXX \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_UNDS,    KC_PLUS,    JA_LBRC, JA_RBRC, S(KC_JYEN), \
