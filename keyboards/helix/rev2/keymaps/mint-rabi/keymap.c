...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   BS |  DEL |   N  |   M  |   ,  |   .  |   /  |¥_ / S|
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Grv   | Esc  | Alt  | GUI  | Alt  |Lower |Space |Enter |Dl/RI | LNG2 | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      KC_LSFT,  KC_Z,    KC_X,     KC_C,    KC_V,   KC_B,  KC_BSPC, KC_DEL,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_T(JA_ENUN) , \
