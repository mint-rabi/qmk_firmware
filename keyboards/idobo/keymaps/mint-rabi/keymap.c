 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | LCTRL  | A      | S      | D      | F      | G      | HOME   | DEL    | PG UP  | H      | J      | K      | L      | ;      | :* /C  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | LEFT   | UP     | RIGHT  | N      | M      | ,      | .      | /      | ¥_ / S |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * |        |        | LGUI   | LALT   | FN     | SPACE  | BACKSP | DOWN   | RIGHT  | SPACE  | SPACE  | FN     | RALT   | RGUI   | RCTRL  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */

 [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    JA_HAT,  KC_1,    KC_2,    KC_3,    KC_4,     KC_5,    KC_LBRC, KC_GRV,  KC_RBRC, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,     KC_T,    KC_HOME, KC_BSLS, KC_PGUP, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    JA_AT, \
    ...
    XXXXXXX, XXXXXXX, KC_LGUI, KC_LALT, MO(_FN),  KC_SPC,  KC_BSPC, KC_DOWN, KC_ESC,  KC_SPC,  MO(_FN), KC_RALT, KC_GRV,  XXXXXXX, XXXXXXX  \
 ),
